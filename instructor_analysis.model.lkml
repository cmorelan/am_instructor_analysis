...
# Including all fields from wa_fact_registration & other tables in model except -course and section instructor ID fields from fact_activation
  fields: [fact_registration*, dim_section*, dim_product_family*, dim_discipline*, dim_time*, dim_school*, dim_textbook*
    , am_wa_contact_namesparsed*, -fact_registration.course_instructor_id, -fact_registration.section_instructor_id]
